...
*/}}
{{- define "accent.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "accent.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{/*
Secret for pull docker image
*/}}
{{- define "accent.imagePullSecret" }}
